...
<div class="admin-content">
	<div class="admin-content-body">
		<div class="am-cf am-padding am-padding-bottom-0">
			<div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">音乐管理</strong> / <small>Table</small></div>
		</div>
      	<hr>
      	<div class="am-g">
        ...
        <div class="am-u-sm-12">
            ...
            <tbody>
              	<c:forEach items="${requestScope.song_list}" var="song"><tr>
	                ...
	                <td>${song.sid}</td>
	                <td><a href="#">${song.sname}</a></td>
	                <td>${song.sauthor}</td>
	                <td class="am-hide-sm-only">${song.stime}</td>
	                ...
	                <td>
	                  <div class="am-btn-toolbar">
	                    <div class="am-btn-group am-btn-group-xs">
	                      ...
	                      <button class="am-btn am-btn-default am-btn-xs am-text-danger am-hide-sm-only remove" title="${song.sid}"><span class="am-icon-trash-o"></span> 删除</button>
	                    </div>
	                  </div>
	                </td>
              	</tr></c:forEach>
            ...
            <div class="am-cf">
				...
				<div class="am-fr">
                	<ul class="am-pagination">
				        ...
				        <c:if test="${currentPage != 1}">
				            <li><a href="manageMusic?page=${currentPage-1}">« </a></li>
				        </c:if>
				        <c:if test="${currentPage == 1}">
				        	<li class="am-active"><a href="#"><span class="current">1</span></a></li>
				        </c:if>
				        <c:if test="${currentPage != 1}">
				        	<li><a href="manageMusic?page=1">1</a></li>
				        </c:if>
				        <%
				        ...
				        <c:if test="${currentPage != page}">
				             <li><a href="manageMusic?page=<%=i+1%>"><%=i+1%></a></li>
				        </c:if>
				        <%} %>
...
<script>
	$(function(){
		$(".remove").click(function(){
			$.post("removeMusic",{sid:this.title},function(){
