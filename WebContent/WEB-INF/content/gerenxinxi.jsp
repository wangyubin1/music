    ...
    <form action="updateUser" method="post" enctype="multipart/form-data">
        <table>
            <tbody>
                ...
                <tr>
                    <td>*&nbsp用户名：</td>
                    <td><input type="text" class="border" name="uname" value="${sessionScope.user.uname}"></td>
                ...
                <tr>
                    <td>邮箱：</td>
                    <td><input type="text" class="border" name="email" value="${sessionScope.user.email}"></td>
                    <td><span id="warmEmail"></span></td>
                </tr>
                <tr>
                    <td>手机号：</td>
                    <td><input type="tel" class="border" name="tel" value="${sessionScope.user.tel}"></td>
                    <td><span id="warmTel"></span></td>
                </tr>
                <tr>
                    <td>头像：</td>
                    <td><img alt="" src="${sessionScope.user.url}" class="pic"><input type="file" class="border" name="file"></td>
                </tr>            	<input type="hidden" value="${sessionScope.user.url}" name="url">
                <tr>
                    <td></td>
                    <td><input type="submit" class="buttom" value="更新" id="submit"></td>
                </tr>
            </tbody>
        </table>
    </form>
